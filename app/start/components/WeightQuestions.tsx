            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            value={value}
                            checked={formData.dataCommunication === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            value={value}
                            checked={formData.distributedProcessing === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            name="performance"
                            value={value}
                            checked={formData.performance === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            value={value}
                            checked={formData.operationalEnvironment === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            name="dataEntry"
                            value={value}
                            checked={formData.dataEntry=== value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            value={value}
                            checked={formData.multipleScreenEntry === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            name="masterFiles"
                            value={value}
                            checked={formData.masterFiles === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            name="complexFiles"
                            value={value}
                            checked={formData.complexFiles === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            value={value}
                            checked={formData.internalProcessing === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            name="reusableCode"
                            value={value}
                            checked={formData.reusableCode === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            name="conversion"
                            value={value}
                            checked={formData.conversion === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            value={value}
                            checked={formData.multipleInstallation === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
            ...
            <div className="mb-4">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((value) => (
                        ...
                        <input
                            ...
                            name="easyUse"
                            value={value}
                            checked={formData.easyUse === value}
                            onChange={(e) => handleChangeInput(e)}
                            className="mr-1"
                        />
                        {value}
